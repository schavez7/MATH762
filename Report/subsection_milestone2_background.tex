...
\begin{equation}
  ...
  \bsig = \mathbb{C}:\beps,
\end{equation}
where $\mathbb{C}$ is a fourth-order elastic tensor. The \textit{Piola-Kirchhoff stress tensor} $\bm{P}$ can be found using the \textif{Cauchy stress tensor} $\bsig$ by
\begin{equation}
